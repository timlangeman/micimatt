...
/* Mobile Button: Created by Tim for Daniel */
if ( ! function_exists( '__after_nav' ) ) {
function __after_nav($items) {
  return $items .= '<div id=”menu_mobile”><span class="fa fa-bars” aria-hidden="true"></span></div>';
}
add_filter('wp_nav_menu','__after_nav');
}
